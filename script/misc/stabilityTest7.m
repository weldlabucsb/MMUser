...
%% Scope
fig = openfig("B:\_Li\_LithiumData\2024\2024.12\12.24\01 - NiLattice_1\dataAnalysis\ScopeValue.fig");
ax = gca;
l = ax.Children;
tScope = l(1).XData;
vScope = l(3).YData;
...
%% PD
t2 = readtable("MeasurementLog20241224 (3)");
...
lg = legend("PID PD","Post-chamber PD");
xlabel("Time [s]")

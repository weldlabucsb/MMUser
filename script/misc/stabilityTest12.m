...
%% MRC
t = readtable("BeamStability4-4-2025_withMRC1enabled.csv");
t0 = t.ms * 1e-3;
v0 = t.I1_V_;
x = t.X1_V_;
y = t.Y1_V_;
...
%% PD
t2 = readtable("MeasurementLog202542 (2)");
% t3 = readtable("MeasurementLog20241218 (2)");
t0 = [t2.Time_UTC_07_00M_d_yyyyH_mm_ssTt_];
t0 = seconds(t0 - t0(1));
vPD = [t2.Mean_A_BetweenRulers__V_ + 0.094];
...
% l = plot(t0,(vPD-vPDMean)/vPDMean,t0,(vPD2-vPD2Mean)/vPD2Mean);
...
saveas(gcf,fullfile("C:\Users\WOODHOUSE\Documents\MMUser\temp",'Power_Stability.png'),'png')
